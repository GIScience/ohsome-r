...
or `rename()` from the `dplyr` package to create such a column as in the example above.
...
Here's a query to extract the full history of OSM building polygon elements with
their geometries:
...
Here, we request the history of OSM buildings for the district of Schweinfurt
