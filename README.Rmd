...
The 
[constributions extraction](https://docs.ohsome.org/ohsome-api/v1/endpoints.html#contributions-extraction){target=blank}
...
Consequently, we filter for features that have had tags changed and visualise 
their locations:
