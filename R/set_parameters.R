...
#' \code{set_filter}, \code{set_groupByKey}, \code{set_groupByKey} and
#' \code{set_groupByValues} are wrapper functions to set specific parameters. By
#' default, an unmodified \code{ohsome_query} object is returned.
#'
